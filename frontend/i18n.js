...
(function () {
  const STRINGS = {
    en: {
      ...
      key_note: "Your security key proves you met us in person — no password needed.",
      email_title: "Claim your spot",
      email_help: "Enter your email, then tap your security key to verify it's you.",
      ...
      msg_unsupported: "This browser doesn't support security keys. Try a recent Chrome, Edge, Firefox or Safari.",
      ...
      msg_submit_failed: "Something went wrong saving your details. Please try again.",
      msg_consent_required: "Please tick the consent box so we can send your swag.",
    ...
    de: {
      ...
      key_note: "Ihr Sicherheitsschlüssel belegt, dass wir uns persönlich getroffen haben — kein Passwort nötig.",
      email_title: "Platz sichern",
      email_help: "Geben Sie Ihre E-Mail ein und bestätigen Sie sich mit Ihrem Sicherheitsschlüssel.",
      ...
      msg_unsupported: "Dieser Browser unterstützt keine Sicherheitsschlüssel. Bitte nutzen Sie ein aktuelles Chrome, Edge, Firefox oder Safari.",
      msg_touch_register: "Berühren Sie Ihren Sicherheitsschlüssel zur Registrierung…",
      msg_touch_login: "Willkommen zurück — berühren Sie Ihren Sicherheitsschlüssel zur Anmeldung…",
      msg_cancelled: "Vorgang abgebrochen. Tippen Sie erneut auf die Schaltfläche.",
      msg_key_failed: "Der Sicherheitsschlüssel konnte nicht verifiziert werden. Bitte erneut versuchen.",
      msg_submitting: "Ihre Angaben werden gespeichert…",
      msg_submit_failed: "Beim Speichern ist etwas schiefgelaufen. Bitte erneut versuchen.",
      msg_consent_required: "Bitte bestätigen Sie die Einwilligung, damit wir Ihren Swag senden können.",
